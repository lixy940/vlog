...
import com.lixy.mapper.custom.CategoryMapperCustom;
...
import com.lixy.mapper.custom.ArticleMapperCustom;
import com.lixy.mapper.custom.TagMapperCustom;
import com.lixy.mapper.generator.ArticleCategoryMapper;
import com.lixy.mapper.generator.ArticleMapper;
import com.lixy.mapper.generator.ArticleTagMapper;
...
import com.lixy.model.domain.ArticleExample;
...
//	@Cacheable(value = ARTICLES_CACHE_NAME, key = "'Post_status'+#status+#post")
	public Integer countByStatus(Integer status, String post,Integer userId) {
		return articleMapperCustom.countByStatus(status, post,userId);
	}
